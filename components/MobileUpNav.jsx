                    ...
                    <div className='flex justify-between px-2 items-center md:pb-3'>
                        <Link href={'/'} className=''>
                            <a className='flex justify-center item-center justify-self-end'>
                                ...
                                <span className='self-center font-extrabold font-[Bunge] sm:text-xl'>GUSTY</span>
                            </a>
                        </Link>
                        <div className="navItems hidden md:flex">
                            <ul className='hidden md:flex space-x-5'>
                                <li>
                                    <Link href={'/'}><a className='hover:text-purple-500 text-md font-semibold'>Home </a></Link>
                                </li>
                                <li>
                        ...
                        <div className="icons ">
                            <Link href={'/login'}><a className='cursor-pointer bg-purple-500 text-sm hover:bg-purple-400 font-[inherit] rounded-sm p-1 mx-1 sm:text-md'>Login</a></Link>
                            <Link href={'/signup'}><a className='cursor-pointer bg-purple-500 text-sm hover:bg-purple-400 font-[inherit] rounded-sm p-1 mx-1 sm:text-md'>Signup</a></Link>
