                                    ...
                                    <div className=" bg-zinc-50 border border-purple-100 shadow-md cursor-pointer " >
                                        <div className="rounded-md  break-inside-avoid-column flex items-center justify-between px-2 sm:px-8 md:px-0 md:p-2">
                                            <div className=' justify-center w-1/4 h-24 sm:w-1/6 p-2 flex items-center sm:h-32 md:justify-start md:w-2/4 md:h-16 md:m-auto lg:pl-4 '>
                                                <img src={category.img} alt="alt" className='bg-transparent  hover:scale-105 aspect-auto  duration-500 max-w-full max-h-full ' />
                                            </div>
                                            <div className='md:pr-8 lg:pr-6'>
                                                <h4 className="font-extrabold text-md sm:text-xl md:text-sm lg:text-xl md:hover:text-purple-500">{category.title}</h4>
                                                <p className='text-gray-500 text-sm md:hidden'>{category.desc}</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
